...
public class Stock extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTabbedPane1.setBackground(new java.awt.Color(237, 238, 255));
        jTabbedPane1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jTabbedPane1.setForeground(new java.awt.Color(151, 153, 155));
        jTabbedPane1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N

        jPanel1.setBackground(new java.awt.Color(237, 238, 255));
        ...
        Tstock.setBackground(new java.awt.Color(238, 237, 255));
        ...
        jPanel2.setBackground(new java.awt.Color(237, 238, 255));

        jPanel3.setBackground(new java.awt.Color(237, 238, 255));
        ...
        jLabel12.setText("bar code path:");

        path.setText("D:\\managementbar\\");
            ...
            Brbc.setBackground(new java.awt.Color(182, 205, 232));
            Brbc.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
            Brbc.setIcon(new javax.swing.ImageIcon("C:\\Users\\DellGhofrane\\OneDrive\\Documents\\NetBeansProjects\\Management\\src\\icone\\icones\\barcode (1).png")); // NOI18N
            Brbc.setText("Read");
            Brbc.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent evt) {
                    BrbcActionPerformed(evt);
                }
            });
            ...
            jPanel3Layout.setHorizontalGroup(
                ...
                .addGroup(jPanel3Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(bc)
                        .addComponent(path, javax.swing.GroupLayout.DEFAULT_SIZE, 249, Short.MAX_VALUE))
            ...
            addqty.setBackground(new java.awt.Color(238, 237, 255));
            ...
            Bsavee.setBackground(new java.awt.Color(182, 205, 232));
    ...
    private void BrbcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BrbcActionPerformed
        // test read bar code here :

                   try{
            
            InputStream barInputStream = new FileInputStream(path.getText());
            ...
            bc.setText(result.getText());
        }catch(Exception e){
            System.out.println(e);
        }
    }//GEN-LAST:event_BrbcActionPerformed
    ...
    private javax.swing.JButton Brbc;
